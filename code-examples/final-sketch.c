...
// we need some time variables to be way easier
int second = 1000;
...
int soggyThreshold = 3400;
int thirstyThreshold = 2900;
...

{
  ...
  // setup our cloud variable
  Particle.variable("soil", moistureReading);
...

{
  ...
  // wait for 12 hours to do it all again
  delay(12 * hour);
